...
$ADMIN[Password] = "lksp";   // This is the password if the above option is Yes
$ADMIN[UploadNum] = "1";  // Number of upload feilds to put on the html page
$ADMIN[directory] = "pixel/";  // The directory the files will be uploaded to (must be chmoded to 777)
